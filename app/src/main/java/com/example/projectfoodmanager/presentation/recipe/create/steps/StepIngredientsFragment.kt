...
import com.example.projectfoodmanager.data.model.modelResponse.recipe.IngredientBase
...
class StepIngredientsFragment : Fragment() {
    ...
    private var itemToUpdated: Ingredient? = null
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.addIngredientBTN.setOnClickListener {
            ...
            if(isUpdate){
                ...
                adapter.addItem(Ingredient(1, IngredientBase(1,binding.ingredientET.text.toString()),binding.quantityET.text.toString()))
                binding.ingredientET.setText("")
                binding.quantityET.setText("")
                binding.ingredientET.clearFocus()
                binding.quantityET.clearFocus()
