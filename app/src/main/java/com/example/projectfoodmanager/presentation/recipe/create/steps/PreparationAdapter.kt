...
class PreparationAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        val itemView = ItemRecipePreparationLayoutBinding.inflate(LayoutInflater.from(parent.context),parent,false)
    ...
    inner class MyViewHolder(private val binding: ItemRecipePreparationLayoutBinding) : RecyclerView.ViewHolder(binding.root) {
